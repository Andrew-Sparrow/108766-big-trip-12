...
const tripView = tripMain.querySelector(`.trip-view`);
const filterEvents = tripMain.querySelector(`.filter-events`);
...
const tripEventsTitle = tripEvents.querySelector(`.trip-events-title`);
  ...
  return (`<form class="trip-events__item  event  event--edit" action="#" method="post" _lpchecked="1">
            <header class="event__header">
              ...
              <div class="event__field-group  event__field-group--destination">
                ...
                <input class="event__input  event__input--destination" id="event-destination-1" type="text" name="event-destination" value="" list="destination-list-1" style="background-image: url(&quot;data:image/png;base64,&quot;); background-repeat: no-repeat; background-attachment: scroll; background-size: 16px 18px; background-position: 98% 50%; cursor: auto;">
...
render(tripMain, tripInfoContainer(), `afterbegin`);

const tripInfoMain = header.querySelector(`.trip-info__main`);

render(tripInfoMain, tripInfoTitle(), `afterbegin`);

render(tripView, tripTabs(), `afterend`);
render(filterEvents, headerFilters(), `afterend`);
// render(tripEventsTitle, firstEventForm(), `afterend`);
render(tripEventsTitle, tripSort(), `afterend`);
render(tripEvents, tripEventForm(), `beforeend`);
