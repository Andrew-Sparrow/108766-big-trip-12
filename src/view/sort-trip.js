...
export const createTripSortTemplate = () => {
  return (`<form class="trip-events__trip-sort  trip-sort" action="#" method="get">
            ...
            <div class="trip-sort__item  trip-sort__item--time">
              ...
              <label class="trip-sort__btn" for="sort-time" data-sort-type="${SortType.DATE_DOWN}">
                Time
...
export default class SortTrip extends AbstractView {
  ...
  setSortTypeChangeHandler(callback) {
    ...
    this.getElement(`.trip-sort__input`).addEventListener(`click`, this._sortTypeChangeHandler);
  }
}
